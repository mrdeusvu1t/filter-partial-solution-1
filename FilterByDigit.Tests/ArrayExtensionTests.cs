...
namespace FilterByDigit.Tests
{
    ...
    public class ArrayExtensionTests
    {
        ...
        public void FilterByPredicate_ArrayIsEmpty_ThrowArgumentException()
        {
            ...
            Assert.Throws<ArgumentException>(() => source.FilterByPredicate(), "Array cannot be empty.");
        }
        ...
        public void FilterByPredicate_ArrayIsNull_ThrowArgumentNullException()
        {
            int[] source = null;
            ArrayExtension.Digit = 0;
            Assert.Throws<ArgumentNullException>(() => source.FilterByPredicate(), "Array cannot be null.");
        }

        [Test]
        public void FilterByPredicate_DigitLessZero_ThrowArgumentOutOfRangeException() =>
            Assert.Throws<ArgumentOutOfRangeException>(() => ArrayExtension.Digit = -1,
                "Expected digit can not be less than zero.");

        [Test]
        public void FilterByPredicate_DigitMoreThanNine_ThrowArgumentOutOfRangeException() =>
            Assert.Throws<ArgumentOutOfRangeException>(() => ArrayExtension.Digit = 13,
                "Expected digit can not be less than zero.");
